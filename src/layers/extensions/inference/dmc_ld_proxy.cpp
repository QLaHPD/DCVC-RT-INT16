...
at::Tensor DMCLDDecoderProxy::forward(const at::Tensor& x, const at::Tensor& conv1_input,
...
at::Tensor DMCLDDecoderProxy::forward_part1(const at::Tensor& x)
{
    return m_up.forward(x);
}

at::Tensor DMCLDDecoderProxy::forward_part2(const at::Tensor& x, const at::Tensor& quant)
{
    const int sm = get_gpu_sm();
    auto out = m_conv10.forward(x);
    out = m_conv11.forward(out);
    out = m_conv12.forward(out);
    out = conv1x1_bias_with_quant(sm, out, m_conv2_weight, m_conv2_bias, quant, m_conv2_out);
    return out;
}

at::Tensor DMCLDDecoderProxy::pre_allocate_tensors(at::Tensor& x, at::Tensor& up_out_buf,
...
void DMCLDDecoderProxy::set_param(const std::map<std::string, at::Tensor>& state_dict)
{
    ...
    m_conv2_weight = state_dict.at("conv2.weight");
    m_conv2_bias = state_dict.at("conv2.bias");
}

at::Tensor DMCLDEncoderProxy::forward(const at::Tensor& x, const at::Tensor& quant)
{
    const int sm = get_gpu_sm();
    auto out = m_conv10.forward(x);
    out = m_conv11.forward(out);
    out = m_conv2.forward(out, quant);
    out = conv_bias(sm, out, m_down_weight, m_down_bias, 2, m_down_out);
    return out;
}

at::Tensor DMCLDEncoderProxy::pre_allocate_tensors(at::Tensor& x)
{
...
void DMCLDEncoderProxy::set_param(const std::map<std::string, at::Tensor>& state_dict)
{
    m_conv10.set_param(get_submodule_state_dict(state_dict, "conv1.0."));
    m_conv11.set_param(get_submodule_state_dict(state_dict, "conv1.1."));
    m_conv2.set_param(get_submodule_state_dict(state_dict, "conv2."));
    m_down_weight = state_dict.at("down.weight");
    m_down_bias = state_dict.at("down.bias");
}

at::Tensor DMCLDFeatureAdaptorIProxy::forward(const at::Tensor& x)
{
...
at::Tensor DMCLDFeatureAdaptorIProxy::pre_allocate_tensors(at::Tensor& x, const at::Tensor& out_buf)
{
...
void DMCLDFeatureAdaptorIProxy::set_param(const std::map<std::string, at::Tensor>& state_dict)
{
...
at::Tensor DMCLDFeatureAdaptorMProxy::forward(const at::Tensor& x)
{
    auto out = m_conv0.forward(x);
    out = m_conv1.forward(out);
    out = m_conv2.forward(out);
...
at::Tensor DMCLDFeatureAdaptorMProxy::pre_allocate_tensors(at::Tensor& x, const at::Tensor& out_buf)
{
    auto out = m_conv0.pre_allocate_tensors(x);
    out = m_conv1.pre_allocate_tensors(out);
    out = m_conv2.pre_allocate_tensors(out);
...
void DMCLDFeatureAdaptorMProxy::set_param(const std::map<std::string, at::Tensor>& state_dict)
{
    m_conv0.set_param(get_submodule_state_dict(state_dict, "conv.0."));
    m_conv1.set_param(get_submodule_state_dict(state_dict, "conv.1."));
    m_conv2.set_param(get_submodule_state_dict(state_dict, "conv.2."));
...
at::Tensor DMCLDFeatureExtractorProxy::forward(const at::Tensor& x)
{
    auto out = m_conv0.forward(x);
    out = m_conv1.forward(out);
    out = m_conv2.forward(out);
...
at::Tensor DMCLDFeatureExtractorProxy::pre_allocate_tensors(at::Tensor& x, const at::Tensor& out_buf)
{
...
void DMCLDFeatureExtractorProxy::set_param(const std::map<std::string, at::Tensor>& state_dict)
{
    m_conv0.set_param(get_submodule_state_dict(state_dict, "conv.0."));
    m_conv1.set_param(get_submodule_state_dict(state_dict, "conv.1."));
    m_conv2.set_param(get_submodule_state_dict(state_dict, "conv.2."));
...
at::Tensor DMCLDHyperDecoderProxy::pre_allocate_tensors(at::Tensor& x, const at::Tensor& out_buf)
{
    auto out = m_conv0.pre_allocate_tensors(x);
    out = m_conv1.pre_allocate_tensors(out);
...
void DMCLDHyperDecoderProxy::set_param(const std::map<std::string, at::Tensor>& state_dict)
{
...
at::Tensor DMCLDHyperEncoderProxy::forward(const at::Tensor& x)
{
    auto out = m_conv0.forward(x);
    out = m_conv1.forward(out);
    out = m_conv2.forward(out);
...
at::Tensor DMCLDHyperEncoderProxy::pre_allocate_tensors(at::Tensor& x)
{
    auto out = m_conv0.pre_allocate_tensors(x, true);  // must not modify!
    out = m_conv1.pre_allocate_tensors(out);
    out = m_conv2.pre_allocate_tensors(out);
...
void DMCLDHyperEncoderProxy::set_param(const std::map<std::string, at::Tensor>& state_dict)
{
    m_conv0.set_param(get_submodule_state_dict(state_dict, "conv.0."));
    m_conv1.set_param(get_submodule_state_dict(state_dict, "conv.1."), false);
...
at::Tensor DMCLDPriorFusionProxy::forward(const at::Tensor& x)
{
    const int sm = get_gpu_sm();
    auto out = m_conv0.forward(x);
    out = m_conv1.forward(out);
...
at::Tensor DMCLDPriorFusionProxy::pre_allocate_tensors(at::Tensor& x, const at::Tensor& out_buf)
{
    m_conv3_out = out_buf;
    auto out = m_conv0.pre_allocate_tensors(x);
    out = m_conv1.pre_allocate_tensors(out);
...
void DMCLDPriorFusionProxy::set_param(const std::map<std::string, at::Tensor>& state_dict)
{
    m_conv0.set_param(get_submodule_state_dict(state_dict, "conv.0."));
    m_conv1.set_param(get_submodule_state_dict(state_dict, "conv.1."));
    m_conv2.set_param(get_submodule_state_dict(state_dict, "conv.2."));
...
at::Tensor DMCLDReconHeadProxy::forward(const at::Tensor& x)
{
    const int sm = get_gpu_sm();
    auto out = m_conv0.forward(x);
    out = m_conv1.forward(out);
    out = m_conv2.forward(out);
    out = conv1x1_bias(sm, out, m_head_weight, m_head_bias, m_head_out);
    out = pixel_shuffle_8_cuda(out, true, m_shuffle_out);
    return out;
}

at::Tensor DMCLDReconHeadProxy::forward_reset(const at::Tensor& x)
{
    const int sm = get_gpu_sm();
    auto out = m_conv0.forward(x);
    out = m_conv1.forward(out);
...
at::Tensor DMCLDReconHeadProxy::pre_allocate_tensors(at::Tensor& x, const at::Tensor& out_buf)
{
    const int H = x.size(2);
    const int W = x.size(3);
    auto options = m_head_weight.options().memory_format(at::MemoryFormat::ChannelsLast);
    const int C = m_head_weight.size(0);
    m_head_out = out_buf;
    m_shuffle_out = at::empty({ 1, C / 64, H * 8, W * 8 }, options);
    auto out = m_conv0.pre_allocate_tensors(x, true);  // must not modify!
    out = m_conv1.pre_allocate_tensors(out);
    out = m_conv2.pre_allocate_tensors(out);
...
void DMCLDReconHeadProxy::set_param(const std::map<std::string, at::Tensor>& state_dict)
{
    m_conv0.set_param(get_submodule_state_dict(state_dict, "conv.0."));
    m_conv1.set_param(get_submodule_state_dict(state_dict, "conv.1."));
    m_conv2.set_param(get_submodule_state_dict(state_dict, "conv.2."));
    m_head_weight = state_dict.at("head.weight");
    m_head_bias = state_dict.at("head.bias");
}

at::Tensor DMCLDSpatialPriorProxy::forward(const at::Tensor& x)
{
    const int sm = get_gpu_sm();
    auto out = m_conv0.forward(x);
    out = m_conv1.forward(out);
    out = conv1x1_bias(sm, out, m_conv2_weight, m_conv2_bias, m_conv2_out);
    return out;
}

at::Tensor DMCLDSpatialPriorProxy::pre_allocate_tensors(at::Tensor& x, at::Tensor& out_buf)
{
    m_conv2_out = out_buf;
    auto out = m_conv0.pre_allocate_tensors(x);
    out = m_conv1.pre_allocate_tensors(out);
...
void DMCLDSpatialPriorProxy::set_param(const std::map<std::string, at::Tensor>& state_dict)
{
    m_conv0.set_param(get_submodule_state_dict(state_dict, "conv.0."));
    m_conv1.set_param(get_submodule_state_dict(state_dict, "conv.1."));
    m_conv2_weight = state_dict.at("conv.2.weight");
    m_conv2_bias = state_dict.at("conv.2.bias");
}

at::Tensor DMCLDTemporalPriorEncoderProxy::forward(const at::Tensor& x)
{
    return m_conv.forward(x);
}

at::Tensor DMCLDTemporalPriorEncoderProxy::pre_allocate_tensors(at::Tensor& x, const at::Tensor& out_buf)
{
...
void DMCLDTemporalPriorEncoderProxy::set_param(const std::map<std::string, at::Tensor>& state_dict)
{
    m_conv.set_param(get_submodule_state_dict(state_dict, "conv."), false);
}

DMCLDProxy::DMCLDProxy()
{
    ...
    m_thread = std::thread(&DMCLDProxy::worker, this);
}
...
void DMCLDProxy::add_ref_feature_from_frame(const at::Tensor& frame, const bool apply_adaptor)
{
    ...
    if (apply_adaptor) {
        ...
        m_temporal_params = m_temporal_prior_encoder.forward(m_memory);
    }
    m_memory_has_value = apply_adaptor;
}

py::tuple DMCLDProxy::compress(const at::Tensor& x, const int qp, const bool reset_feature_memory,
                               const int padding_b, const int padding_r)
{
    ...
    auto lambda_enc_0 = [&](const int qp) {
        ...
        m_temporal_params = multiply_with_broadcast_cuda(m_temporal_params, m_q_feature[qp],
                                                         m_temporal_params);  // inplace
        ...
        m_means = m_y_spatial_prior.forward(m_cat_spatial_prior);
        std::tie(m_y_q, m_y_hat) = process_with_mask_no_scale_add_and_multiply_inplace_cuda(
            y, scales, m_means, m_mask_1, m_y_q, m_y_hat, q_dec, m_skip_threshold, 0);
...
at::Tensor DMCLDProxy::decompress(const py::array_t<uint8_t>& bit_stream, const int qp,
                                  const int height, const int width,
                                  const int entropy_coder_parallel, const bool reset_feature_memory)
{
    m_result_ready = false;
    ...
    auto lambda_dec_0 = [&](const bool memory_has_value) {
        apply_feature_adaptor(memory_has_value);
        m_temporal_params = m_temporal_prior_encoder.forward(m_memory);
    };

    run(lambda_dec_0, m_gexec_dec_0, m_memory_has_value);
    // ------------ end of lambda_dec_0 ------------
    ...
    auto lambda_dec_1 = [&](const int qp) {
    ...
    run(lambda_dec_1, m_gexec_dec_1, m_qp);
    // ------------ end of lambda_dec_1 ------------
    ...
    auto lambda_dec_3 = [&](const int qp) {
        ...
        m_means = m_y_spatial_prior.forward(m_cat_spatial_prior);
        m_y_hat = restore_y_and_add_multiply_inplace_cuda(m_y_q_r, m_means, m_mask_1, m_y_hat, q_dec);
        // decoder + recon_head
        m_feature_p = m_decoder.forward(m_y_hat, m_cat_decoder, m_q_decoder[qp]);
        m_x_hat = m_recon_head.forward(m_feature_p);  // m_feature_i is also updated for reset purpose
    };
...
void DMCLDProxy::set_param(const std::map<std::string, at::Tensor>& state_dict, const float skip_threshold)
{
...
void DMCLDProxy::add_ref_feature_and_apply_adaptor(const at::Tensor& feature,
...
void DMCLDProxy::apply_feature_adaptor(const bool memory_has_value)
{
    if (memory_has_value) {
        m_memory = m_feature_adaptor_m.forward(m_cat_feature_adaptor_m);
    } else {
...
void DMCLDProxy::clear_cuda_graph()
{
    for (int i = 0; i < g_qp_num; ++i) {
    ...
    for (int i = 0; i < 2; ++i) {
        destroy_cuda_graph_exec(m_gexec_dec_0[i]);
    }
    destroy_cuda_graph_exec(m_gexec_dec_2);
    for (int i = 0; i < g_qp_num; ++i) {
        destroy_cuda_graph_exec(m_gexec_dec_1[i]);
        destroy_cuda_graph_exec(m_gexec_dec_3[i]);
    }
}

std::tuple<at::Tensor, at::Tensor> DMCLDProxy::get_mask_2x(const at::Tensor& y)
{
    const int C = y.size(1);
    const int H = y.size(2);
    const int W = y.size(3);
    auto m = at::ones({ 1, C / 2, H, W }, y.options().dtype(at::kBool));
    auto m0 = get_one_mask(torch::tensor({ { 1, 0 }, { 0, 1 } }, y.options().dtype(at::kBool)), H, W);
    auto m1 = get_one_mask(torch::tensor({ { 0, 1 }, { 1, 0 } }, y.options().dtype(at::kBool)), H, W);

    auto mask_0 = at::cat({ m * m0, m * m1 }, 1).contiguous(at::MemoryFormat::ChannelsLast);
    auto mask_1 = at::cat({ m * m1, m * m0 }, 1).contiguous(at::MemoryFormat::ChannelsLast);

    return { mask_0, mask_1 };
}

void DMCLDProxy::pre_allocate_tensors(const at::Tensor& frame)
{
    int H = frame.size(2);
    int W = frame.size(3);
    H = (H + 16 - 1) / 16 * 16;
    ...
    const std::vector<int64_t> feature_i_shape = { 1, g_ch_src_d, H8, W8 };
    ...
    std::tie(m_mask_0, m_mask_1) = get_mask_2x(y);
    ...
    assert(g_ch_d > g_ch_src_d);
    at::Tensor tensor_placeholder;
    m_cat_decoder = at::empty({ 1, g_ch_d + g_ch_m, H8, W8 }, options);
    std::tie(tensor_placeholder, m_cat_encoder) =
        split_tensors_2(m_cat_decoder, g_ch_d - g_ch_src_d, g_ch_src_d + g_ch_m);
    std::tie(tensor_placeholder, m_enc_unshuffle_out, m_ctx) =
        split_tensors_3(m_cat_decoder, g_ch_d - g_ch_src_d, g_ch_src_d, g_ch_m);
    std::tie(m_decoder_up_out, m_ctx) = split_tensors_2(m_cat_decoder, g_ch_d, g_ch_m);
    ...
    // 4. deal with m_cat_spatial_prior, m_y_hat, and m_common_params
    m_cat_spatial_prior = at::empty({ 1, g_ch_y * 4, H16, W16 }, options);
    std::tie(m_y_hat, m_common_params) = split_tensors_2(m_cat_spatial_prior, g_ch_y, g_ch_y * 3);

    // pre allocate other tensors
    m_feature_i = g_tensor_pool.empty(feature_i_shape, options);
    ...
    m_temporal_prior_encoder.pre_allocate_tensors(m_memory, m_temporal_params);
    m_hyper_decoder.pre_allocate_tensors(m_z_hat, m_hyper_params_pad4);
    m_y_prior_fusion.pre_allocate_tensors(m_cat_prior_fusion, m_common_params);
    m_y_spatial_prior.pre_allocate_tensors(m_cat_spatial_prior, m_means);
    ...
    m_x_hat = m_recon_head.pre_allocate_tensors(m_feature_p, m_feature_i);
}
