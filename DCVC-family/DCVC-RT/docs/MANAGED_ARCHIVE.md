...
- `--auto-delete`: validate and delete exact inventoried source-video paths.
...
7. Known thumbnail sidecars are retained.
8. No duplicate basename, symlink, traversal, or unexpected-root condition exists.

Cleanup unlinks only exact inventoried source containers. It does not use globs, recursive removal, or directory deletion. Metadata, thumbnails, `.bin`, `.opus`, manifests, audit records, and progress logs are retained.
